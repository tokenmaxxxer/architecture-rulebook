#!/usr/bin/env python3
"""issue #22 / #551 — canonical test-env resolution convention.

Verbatim vendor of the on-the-record reference module
`gates/test_env_resolve.py` (docs/specs/test-env-resolution.md, issue
#551, tokenmaxxxer/on-the-record). Do not modify independently of that
source — changes belong upstream first.
